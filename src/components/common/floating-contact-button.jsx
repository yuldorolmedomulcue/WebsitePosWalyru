...
function FloatingContactButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Menú desplegable */}
      {isOpen && (
        <div className="absolute bottom-20 right-0 bg-white rounded-2xl shadow-2xl p-4 w-64 animate-in fade-in slide-in-from-bottom-4 duration-300">
          {/* Opción 1: Llamada */}
          <button
            onClick={handleCall}
      ...
      <button
        ...
        className={`relative w-16 h-16 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center group ${
          isOpen
      ...
      >
        ...
        {!isOpen ? (
          <>
            <img src="/images/acceso1.png" alt="Contactar" className="w-20 h-15" />
            {/* Badge de "Hablemos" */}
